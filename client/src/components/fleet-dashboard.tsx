...
import { TrendingUp, Calendar, MapPin, AlertTriangle, CheckCircle, Truck } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-600 max-w-3xl mx-auto" data-testid="text-dashboard-description">
            Monitor and optimize your fleet operations with comprehensive real-time analytics
          </p>
        </div>

        {/* Dashboard Container */}
        <div className="bg-white rounded-3xl shadow-2xl border border-slate-200 p-8 max-w-6xl mx-auto" data-testid="fleet-dashboard">
          {/* Dashboard Header */}
